...
/*
$ make run CLASS=LazyDijkstraSPs ARGS="../data/tinyEWD.txt 0"
0 to 0 (0.00):
...
$ make run CLASS=LazyDijkstraSPs ARGS="../data/tinyEWG.txt 0"
0 to 0 (0.00):
0 to 1 (Infinity):
0 to 2 (0.26): 0->2 0.26000
...
public class LazyDijkstraSPs {
    ...
    public static void main(String[] args) {
        if (args.length == 0) {
            StdOut.println("usage: java LazyDijkstraSPs <file> <source> [<path> | sum]");
            return;
        }
        ...
        LazyDijkstraSPs sp = new LazyDijkstraSPs(G, s);
